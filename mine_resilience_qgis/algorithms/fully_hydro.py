"""Global, public-data-capable QGIS implementation of Fully Hydro Preparation."""
...
class FullyHydroPreparationAlgorithm(QgsProcessingAlgorithm):
    ...
    def displayName(self):
        return "Fully Hydro Preparation 4.2 - Global QGIS"
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        qa = {
            "product": "Fully Hydro Preparation 4.2 - Global QGIS Edition",
    ...
    def postProcessAlgorithm(self, context, feedback):
        ...
        group = project.layerTreeRoot().findGroup("Fully Hydro Preparation - Global")
        if group is None:
            group = project.layerTreeRoot().addGroup("Fully Hydro Preparation - Global")
        boundary_layer = None
